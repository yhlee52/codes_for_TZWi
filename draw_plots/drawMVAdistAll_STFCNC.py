...
f = TFile.Open("stzut/shape_stzut_fix.root")
#f = TFile.Open("stzut/shape_stzut_BDT.root")
...
#def drawplot (hdata, hbkg, hsig, channel):
    ...
    c.SaveAs("MVAdist_All_stzut_fix.png")
...
for i, channel in enumerate(chlist):
    ...
    hsigtmp = f.Get("%s_stzut"%channel)
    hdata.Add(hdatatmp)
    hsig.Add(hsigtmp)
leg.AddEntry(hsig, "stzut", "l")
