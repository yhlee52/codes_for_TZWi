...
class FCNCKinematicReco(Module, object):
    ...
    def beginFile(self, inputFile, outputFile, inputTree, wrappedOutputTree):
        ...
        self.out.branch("KinTop_deta", "F")
        self.out.branch("KinTop_dphi", "F")
    ...
    def analyze(self, event):
        ...
        if event._tree.b_out_GoodLeptonCode != 111 or\
           not( 1 <= event._tree.b_out_nGoodJet <= 3 ) or\
           ...
           NPLflag == 0:
            ...
            self.out.fillBranch("KinTop_deta", 0)
            self.out.fillBranch("KinTop_dphi", 0)
            ...
            if ( event._tree.b_out_nGoodJet > 1 ):
                ...
                qjetDeepFlavB = event._tree.b_out_GoodJet_DeepFlavB[1]
            #bjetCSV, qjetCSV = event._tree.b_out_GoodJet_CSVv2[0], event._tree.b_out_GoodJet_CSVv2[1]
            bjetDeepFlavB = event._tree.b_out_GoodJet_DeepFlavB[0]
	    ...
	    if ( event._tree.b_out_nGoodJet > 1 ):
            ...
            self.out.fillBranch("KinTop_deta", abs(SMTKinVal[1]-FCNCKinVal[1]))
            self.out.fillBranch("KinTop_dphi", abs(SMTKinVal[2]-FCNCKinVal[2]))
